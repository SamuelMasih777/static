  ...
  const apps = [
    {
      ...
      appLink: "https://storage.googleapis.com/myrik-apks/RIDER.apk",
    },
    {
      title: "MyRik Driver",
      image: RiderLogo,
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-36 px-4">
      <div className="mx-auto text-center">
        ...
        <div className="grid grid-rows-1 md:grid-rows-2 gap-20 justify-items-center mx-auto px-4">
          {apps.map((app) => (
            <div
              key={app.title}            
              ...
              {/* Conditional rendering for toggled card content */}
              {
                <div className="flex flex-col space-y-8">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-md sm:text-md md:text-md lg:text-lg xl:text-lg text-white/90">
                      {app.description}
                    </p>
                  </div>
                  <div className="flex items-center justify-center gap-4 -mt-4 ">
                    <button
                      className="flex items-center justify-center text-white rounded-lg  transition duration-200 p-2"
                      onClick={() =>
